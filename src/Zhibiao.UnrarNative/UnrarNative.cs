...
namespace Zhibiao.UnrarNative
{
    ...
    public partial class Unrar
    {
        static Unrar()
        {
            var fileName = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), Environment.Is64BitProcess ? "x64" : "x86", "UnRAR.dll");
        ...
        [DllImport("UnRAR.dll")]
        protected static extern IntPtr RAROpenArchive(ref RAROpenArchiveData archiveData);
        ...
        /// <returns>Archive handle or NULL in case of error.</returns>
        [DllImport("UnRAR.dll")]
        protected static extern IntPtr RAROpenArchiveEx(ref RAROpenArchiveDataEx archiveData);
        ...
        /// <returns></returns>
        [DllImport("UnRAR.dll")]
        protected static extern int RARCloseArchive(IntPtr hArcData);
        ...
        /// <returns></returns>
        [DllImport("UnRAR.dll")]
        protected static extern RarError RARReadHeader(IntPtr hArcData, ref RARHeaderData headerData);
        ...
        /// <returns></returns>
        [DllImport("UnRAR.dll")]
        protected static extern RarError RARReadHeaderEx(IntPtr hArcData, ref RARHeaderDataEx headerData);
        ...
        /// <returns></returns>
        [DllImport("UnRAR.dll")]
        protected static extern RarError RARProcessFile(IntPtr hArcData, Operation operation,
        ...
        /// <returns></returns>
        [DllImport("UnRAR.dll")]
        protected static extern RarError RARProcessFileW(IntPtr hArcData, Operation operation,
        ...
        /// </param>
        [DllImport("UnRAR.dll")]
        protected static extern void RARSetCallback(IntPtr hArcData, UNRARCallback callback, long userData);
        ...
        [DllImport("UnRAR.dll")]
        protected static extern void RARSetPassword(IntPtr hArcData,
        ...
        /// </returns>
        [DllImport("UnRAR.dll")]
        protected static extern int RARGetDllVersion();
    }
}
